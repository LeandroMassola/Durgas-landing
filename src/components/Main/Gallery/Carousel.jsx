...
export default function Carousel({scrollY, setScroll, setIsClicked, setImgPicked, images}) {
    ...
    return(
        <motion.div initial={{opacity:0.5}} whileInView={{opacity:1}} transition={{duration:1, delay:0.7}} className="w-full h-full px-5 py-1 z-50 relative bg-gradient-to-b from-[var(--afterglow)] via-[var(--barelyPink)] to-[var(--andorra)]/5  ">
