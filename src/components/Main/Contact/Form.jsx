...
export default function Form() {
    ...
    return(
        <section className=" absolute w-full bg-gradient-to-b from-[var(--afterglow)] via-[var(--afterglow)]/20 to-[var(--afterglow)]/40 py-10 text-[var(--andorra)]">
            ...
            <h1 className="text-center text-4xl z-50 relative mt-20 text-[var(--afterglow)] ">Escribínos</h1>

            {statusSend != null && <h3>{statusSend}</h3>}
            <form className="relative mt-20" method="POST" action="#" onSubmit={handleSubmit}>
                <div  className="flex flex-col justify-center items-center gap-3 w-full h-full">
                    <label className="flex text-[var(--afterglow)] tracking-widest font-extralight text-lg flex-col text-center" htmlFor="name">Nombre
                    ...
                    <label className="flex text-[var(--afterglow)] tracking-widest font-extralight text-lg flex-col text-center" htmlFor="surname">Apellido
                    ...
                    <label className="flex text-[var(--afterglow)] tracking-widest font-extralight text-lg flex-col text-center" htmlFor="mail">Mail
                    ...
                    <label className="flex text-[var(--afterglow)] tracking-widest font-extralight text-lg flex-col text-center" htmlFor="subject">Asunto
                    ...
                    <label className="flex text-[var(--afterglow)] tracking-widest font-extralight text-lg flex-col text-center" htmlFor="message">Mensaje
                ...
                <div className="flex px-15 justify-around items-center">
                    <button className="text-xl border-1 px-3 py-1 pt-2.5 mt-5 rounded-sm bg-[var(--andorra)] text-[var(--afterglow)] active:bg-[var(--afterglow)] active:text-[var(--andorra)]" type="submit">Enviar</button>
                    <button className="text-xl border-1 px-3 py-1 pt-2.5 mt-5 rounded-sm bg-[var(--afterglow)] active:bg-[var(--andorra)] active:text-[var(--afterglow)]" type="reset">Limpiar</button>
                </div>
            </form>
        </section>
    )
