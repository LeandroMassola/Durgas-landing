...
import {motion} from 'motion/react'
    ...
    export default function Header({isWelcomeVisible, burgerClicked, setBurgerClicked}) {
        ...
        return(
            ...
            <header className=" w-full fixed z-10 bg-black/40 ">
                {!isWelcomeVisible && 
                    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: [0.2, 0.3, 0.5, 0.7, 0.8, 1]}} transition={{duration:0.7, delay:0, ease:"easeInOut"}} className="flex flex-row-reverse z-50 pr-5">
